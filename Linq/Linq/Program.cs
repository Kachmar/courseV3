    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Car> myCars = new List<Car>() {
                                                       new Car()
                                                           {
                                                               VIN="A1", Make = "BMW", Model= "550i", StickerPrice=55000, Year=2020,
                                                               Owner = ownerSuzy,
                                                           },
                                                       new Car()
                                                           {
                                                               VIN="B2", Make="Toyota", Model="4Runner", StickerPrice=35000, Year=2021,
                                                               Owner = ownerSuzy
                                                           },
                                                       new Car()
                                                           {
                                                               VIN="C3", Make="BMW", Model = "745li", StickerPrice=75000, Year=2019,
                                                               Owner = ownerMax
                                                           },
                                                       new Car()
                                                           {
                                                               VIN="D4", Make="Ford", Model="Escape", StickerPrice=25000, Year=2019,
                                                               Owner = ownerPetro
                                                           },
                                                       new Car()
                                                           {
                                                               VIN="E5", Make="BMW", Model="55i", StickerPrice=57000, Year=2021,
                                                               Owner = ownerMax
                                                           }
                                                   };
            ...
            //Student Task : create query to return cars older then 2021 year and price less then 50000
            ...
            //Student Task : create query to 1)if any cars cheaper than 30000 2) Are all cars younger than 2019?
            //Commonly used 'Any';
            var anyCheapCars = myCars.Any(car => car.StickerPrice < 30000);
            //All
            Console.WriteLine(myCars.All(p => p.Year > 2019));
            //Group By
